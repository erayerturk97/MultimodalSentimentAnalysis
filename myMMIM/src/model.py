...
class MMIM(nn.Module):
    ...
    def forward(self, sentences, visual, acoustic, v_len, a_len, bert_sent, bert_sent_type, bert_sent_mask, y=None, mem=None, lengths=None, hubert_feats=None, hubert_feats_att_mask=None, hubert_embeddings=None):
        """
