...
if 'mosi' in args.dataset:
    args.dataset_dir = f'{PROJECT_DIR}/datasets/MOSI'
elif 'mosei' in args.dataset:
    args.dataset_dir = f'{PROJECT_DIR}/datasets/MOSEI'
...
args.mode = 'train'
train_data, train_loader = get_loader(args, shuffle = True)
args.mode = 'dev'
valid_data, valid_loader = get_loader(args, shuffle = False)
args.mode = 'test'
test_data, test_loader = get_loader(args, shuffle = False)
